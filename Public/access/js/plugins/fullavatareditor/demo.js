swfobject.addDomLoadEvent(function () {
        ...
        switch (json.code) {
            ...
            case 5:
                ...
                if (json.type == 0) {
                    ...
                    header_img.val(json.content.sourceUrl);
                    $('.button_upload').hide();
                }
                else {
    ...
    var swf1 = new fullAvatarEditor('swf1', 335, {
		id : 'swf1',
        upload_url : "act_add?action=upload_header_img",
		...
		avatar_sizes : '120*120',			//定义单个头像
		avatar_sizes_desc :'120*120',	   //头像尺寸的提示文本。
    ...
    var swf2 = new fullAvatarEditor('swf2', {
        id: 'swf2',
        upload_url: "act_add.html?action=upload_header_img",	//上传图片的接口地址
