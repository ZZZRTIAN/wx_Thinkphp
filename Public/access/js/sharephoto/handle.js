...
window.ShearPhoto.MINGGE(function() {
	...
	Shear.config({
		...
		url: "http://localhost/shearphoto/shearphoto_common/php/upload.php", //后端处理地址，保证正确哦，这是常识，连这个地址都能写错，你就是菜B，已经在本版本中帮你加入相对路径，你基本不用改这里了
	...
	var Upfile = document.getElementById("UpFile"); //FORM对象
	...
	$('#shearphoto_main').css('visibility', 'visible');
	/*................2.2加入的缓冲效果结束..................*/
});